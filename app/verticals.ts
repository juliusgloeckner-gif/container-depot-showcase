...
const refrigerated: Vertical = {
  ...
  galleryLead: "After the standard 10-day depot electrical test and report, refrigerated containers can support food, floral, laboratory, medical, industrial and high-value inventory when the exact product requirements, site power, airflow and monitoring plan are confirmed.",
  gallery: [
  ...
  applications: ["Produce and floral stock", "Beverages and kegs", "Pharmaceutical cold chain", "Laboratory reagents", "Sensitive electronics", "Approved industrial materials"],
  useCaseMosaic: {
    eyebrow: "Far more than food",
    title: "Nine very different temperature-controlled loads.",
    lead: "Reefers can support food, floral, medical, laboratory, industrial and high-value inventory. Each load still needs its own setpoint, monitoring, packaging, sanitation, compatibility and handling plan.",
    image: "/specialty/reefer-use-mosaic-v2.webp",
    columns: 3,
    items: ["Fresh produce", "Cut flowers and nursery stock", "Beverages and kegs", "Pharmaceuticals and biologics", "Laboratory reagents and diagnostics", "Chocolate and confectionery", "Sensitive electronic components", "Art and archival materials", "Approved temperature-sensitive industrial materials"],
    note: "These loads do not share one universal setting. The 10-day electrical test confirms operation of the purchased unit, but it does not by itself validate storage for a particular product. Medical, pharmaceutical, laboratory, electronics, art and industrial loads require product-owner specifications, exact-unit qualification, temperature mapping and monitoring, compatible packaging and segregation, and all applicable manufacturer and regulatory procedures.",
  },
  technicalNotes: [
...
const doubleDoor: Vertical = {
  ...
  hero: "/specialty/tunnel-hero-v2.webp",
  featureImage: "/specialty/tunnel-interior.webp",
  inventoryImages: ["/specialty/tunnel-construction.webp", "/specialty/tunnel-warehouse-v3.webp", "/specialty/tunnel-high-cube-v4.webp", "/specialty/tunnel-interior.webp"],
  ...
  gallery: [
    ...
    { image: "/specialty/tunnel-warehouse-v3.webp", alt: "Accurately proportioned forty foot green tunnel container with paired cargo doors at both short ends beside a distribution warehouse", caption: "First-in-first-out inventory beside the warehouse" },
    { image: "/specialty/tunnel-warehouse-blue-v4.webp", alt: "Accurately proportioned forty foot blue double-door tunnel container with open cargo doors at the near short end and a complete second door pair at the far short end", caption: "Load and retrieve from the closest end" },
  ],
...
const insulated: Vertical = {
  ...
  featureImage: "/specialty/insulated-feature-monitoring-v3.webp",
  inventoryImages: ["/specialty/insulated-20ft-records-v3.webp", "/inventory-v3/generic-40.jpg", "/inventory-v2/generic-3.jpg", "/specialty/insulated-monitored-interior-v2.webp"],
  ...
  gallery: [
    { image: "/specialty/insulated-gallery-furniture-v3.webp", alt: "Twenty foot rust-red insulated shipping container with a sealed white liner protecting wrapped furniture, archive boxes and equipment cases", caption: "Protect records, instruments and packaged dry goods" },
...
const hazardousMaterial: Vertical = {
  ...
  featureImage: "/specialty/hazmat-container-hero-v3.webp",
