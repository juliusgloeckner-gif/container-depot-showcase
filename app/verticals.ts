...
const doubleDoor: Vertical = {
  ...
  gallery: [
    ...
    { image: "/specialty/tunnel-warehouse-blue-v3.webp", alt: "Accurately proportioned forty foot blue double-door tunnel container with two outward-opening cargo doors at each short end and a clear warehouse aisle", caption: "Load and retrieve from the closest end" },
  ],
