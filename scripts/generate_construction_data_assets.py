...
CARDS = [
    ...
    },
    {
        ...
        "value": "32% + 68% = 100%",
        "body": "FMI divides active-site time into 32% recoverable lost time and 68% primary plus secondary time. The listed delays are examples within the 32%, not additional shares.",
